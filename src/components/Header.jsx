...
function Header() {
  ...
  return (
    <header className={`sticky z-50 bg-gradient-to-r from-blue-100 to-royalBlue top-0 text-darkBlue font-semibold min-h-14  p-5 md:py-2  `}>
        ...
        <div className="hidden md:flex ml-auto h-fit">
          <nav className="flex space-x-8 text-xl">
            <NavLink
              to="/about"
              className={({ isActive }) =>
                `max-w-fit relative hover:no-underline before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-full before:bg-darkBlue before:origin-left before:scale-x-0 hover:before:scale-x-100 before:transition-transform before:duration-300 ${
            ...
            <a
              ...
              className="max-w-fit relative hover:no-underline before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-full before:bg-darkBlue before:origin-left before:scale-x-0 hover:before:scale-x-100 before:transition-transform before:duration-300 "
            >
              Products
            </a>
            <a
      ...
      {isMenuOpen && (
        ...
        >
          <NavLink
            ...
            className={({ isActive }) =>
              `block py-2 text-white hover:text-gray-300 ${isActive ? 'underline' : ''}`
            }
          >
            About
          </NavLink>
