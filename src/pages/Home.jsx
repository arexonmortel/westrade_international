...
function Home() {
  return (
    <section className="relative bg-gradient-to-r  py-20 w-full h-full md:h-screen">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-6 md:px-40 space-y-6 md:space-y-0">
        ...
        <div className="flex justify-center md:justify-end">
          <img
            className="rounded-full md:h-96 md:w-96 w-60 h-60 shadow-lg transform hover:scale-105 transition-all duration-500 bg-lightBlue"
            src={logo}
            alt="Westrade Logo"
          />
        </div>
